...
satyanandatripathi = "EMCEE"
telegraph = Telegraph()
r = telegraph.create_account(short_name=satyanandatripathi)
auth_url = r["auth_url"]
...
__help__ = """ 
to use Telegraph follow below steps 

❍ /tm (by replying media file) : to upload media (max lim=5mb)
❍ /txt (by replying text) : to upload text
"""
